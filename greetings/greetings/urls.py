...
from my_app.views import HelloWorldView
from my_app.views import GoodMorningView
from my_app.views import GoodEveningView
from my_app.views import GoodAfterNoonView
urlpatterns = [
